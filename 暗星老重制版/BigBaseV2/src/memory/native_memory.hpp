...
namespace memory
{
	...
	template <typename T>
	inline void set_selfvalue(uintptr_t base_address, std::vector<DWORD> offsets, T value) {
	...
	template <typename T>
	inline T get_selfvalue(uintptr_t base_address, std::vector<DWORD> offsets) {
